...
var DatatablesAndCRUDOperationServerSide = function() {
                    ...
                    render: function (data) {
                        return `
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input checkbox-input-id" value="${data}" />
                            </div>`;
                    }
                },
    ...
    var toggleToolbars = function() {
        ...
        const toolbarSelected = document.querySelector('[data-groups-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[ data-groups-table-select="selected_count"]');
