...
var DatatablesServerSide = function() {
                ...
                columnDefs: [
...

                    {
                        ...
                        render: function (data, type, row) {
                            let view_url = api_config.view_url.replace('0', encodeURIComponent(row.encrypt_id.toString()));
                            return `
                            <a href="${view_url}" class="btn btn-icon btn-bg-light btn-active-color-info btn-sm d-flex justify-content-center align-items-center">
                            ...
                            if (categoryDeleteValue === 'True' && categoryEditValue === 'True') {
                                ...
                                return `
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a href="${edit_url}" class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1"  >
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#00A300">
                                        ...
                                        <a href="javascript:void(0)" data-id=${row.id} data-users-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#CA0B00">
                                ...
                                document.getElementById('actions-column-header').classList.add('hidden-column-header');
                            return null;
                            }
    ...
    var toggleToolbars = function() {
        ...
        if (checkedState) {
            ...
            // Hide the action and status table columns
            dt.columns([3]).visible(false);
        } else {
            toolbarBase.classList.remove('d-none');
            toolbarSelected.classList.add('d-none');
            // Show the action and status table columns
            dt.columns([3]).visible(true);
            // Hide edit and delete buttons when no checkboxes are checked
        }
        ...
        headerCheckbox.addEventListener('click', function() {
            ...
            if (checkedState) {
                ...
                // Show the action and status table columns
                dt.columns([3]).visible(true);
                // Hide edit and delete buttons when "Select All" checkbox is unchecked
            }
        });
