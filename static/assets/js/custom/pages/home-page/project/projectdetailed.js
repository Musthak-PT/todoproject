            ...
            columnDefs: [
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (data == 'True') {
                            label_badge_change = 'Contacted';
                            buttonClass = 'btn-outline-success';
                        } else if (data == 'False') {
                            label_badge_change = 'Not Contacted';
                            buttonClass = 'btn-outline-danger';
                        }
                
                        return `<button type="button" style="cursor:pointer" data-id="${row.id}" class="btn btn-sm ${buttonClass} active_inactive_language">${label_badge_change}</button>`;
                    }
                },
                {
                    searchable: false,
