    ...
    var initDatatable = function() {
        ...
        dt = $("#company-profile-datatable").DataTable({
            ...
            columnDefs: [
                ...
                //         if(data == 'True'){
                //             label_badge_change = `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-success btn-active-light-success active_inactive_language">Contacted</span>`;
                //         }else if(data == 'False'){
                //             label_badge_change =  `<span style="cursor:pointer" data-id=${row.id}  class="btn btn-sm btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger active_inactive_language">Not Contacted</span>`;
                //         }
